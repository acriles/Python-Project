...
"                }")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("cubo-3d.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"                }")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("carrinho-de-compras.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"                }")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("engrenagens.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pushButton_fechar_frame_options.setStyleSheet("QPushButton {\n"
                                             ...
                                             "                }")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("remover.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"                }")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("grupo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_3.setPixmap(QtGui.QPixmap("Capturar.PNG"))
...
"                }")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("sair.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("usuario-de-perfil2.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"                }")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("casa.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_5.setPixmap(QtGui.QPixmap("UF.PNG"))
